			...
			<>
				...
				<HeaderExpand>
					<Body className="px-4 py-4 md:px-28 md:py-8 lg:py-12 flex items-center flex-1">
						...
						<div>
							<div className="text-4xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 inline-block">Desktop AI<span className="font-normal "> 4U</span>
								<div className="absolute top-0 ml-3 left-full bg-gradient-to-br from-gray-666 to-gray-666 text-white text-sm px-2 py-0.5 rounded-md font-normal hidden md:flex"> .com</div>
							</div>
				...
				<div className="border-b border-gray-300 bg-white shadow-sm ">
					<div className="container flex mx-auto px-4 md:px-28 flex select-none">
						<NavLink to="/"
							...
							<div className="hidden lg:block">Menu-Templates</div>
						</NavLink>
